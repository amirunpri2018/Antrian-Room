                ...
                <div class="dropdown">
                  <a class="nav-link pr-0 leading-none" data-toggle="dropdown">
                    ...
                    <span class="ml-2 d-none d-lg-block">
                      <span class="text-default">Hai Kamu</span>
          ...
          <div class="container">
            <div class="row align-items-center">
              <div class="col-lg-3 ml-auto">
                                <a class="pull-right" href="<?php echo base_url('login') ?>"><i class="fe fe-users"></i> Login Reservasi</a>
              ...
              <div class="col-lg order-lg-first">
                <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                  <li class="nav-item">
                    <a href="<?php echo base_url('home') ?>" class="nav-link"><i class="fe fe-calendar"></i> List Antrian Room</a>
                  </li>
                  <li class="nav-item">
                    <a href="<?php echo base_url('daftar') ?>" class="nav-link"><i class="fa fa-address-card-o"></i> Daftar Room</a>
                  </li>
                </ul>
              </div>
            </div>
